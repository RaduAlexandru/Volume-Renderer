...
public:
    ...
    void setupUi(QMainWindow *VolumeRendererClass)
    {
        ...
        VolumeRendererClass->resize(1211, 713);
        ...
        frameSlider->setGeometry(QRect(1030, 540, 121, 22));
        ...
        label_6->setGeometry(QRect(1160, 550, 47, 13));
        ...
        groupBox->setGeometry(QRect(1060, 130, 141, 80));
        ...
        groupBox_2->setGeometry(QRect(20, 130, 171, 101));
        ...
        checkBox_2->setGeometry(QRect(20, 520, 81, 17));
    ...
    void retranslateUi(QMainWindow *VolumeRendererClass)
    {
        ...
        interpolateDepthText->setText(QApplication::translate("VolumeRendererClass", "1", 0));
        ...
        checkBox_2->setText(QApplication::translate("VolumeRendererClass", "showCubes", 0));
