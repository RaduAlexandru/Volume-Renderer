...
public:
    ...
    void setupUi(QMainWindow *VolumeRendererClass)
    {
        ...
        glwidget->setGeometry(QRect(0, 10, 1361, 281));
        ...
        borderYBottomSlider->setValue(100);
        ...
        horizontalSlider->setGeometry(QRect(1100, 600, 231, 22));
        horizontalSlider->setOrientation(Qt::Horizontal);
        horizontalSlider_2 = new QSlider(centralWidget);
        horizontalSlider_2->setObjectName(QStringLiteral("horizontalSlider_2"));
        horizontalSlider_2->setGeometry(QRect(1100, 620, 231, 22));
